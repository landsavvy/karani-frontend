<template>
  <div>
    ...
    <div class="card shadow mb-4" v-if="transfer">
      ...
      <div class="card-body">
        Click approve to approve Transfer (acting as the land Control Board)
        <table class="m-4">
          <tbody>
            <tr>
              <td>Title Number</td>
...
export default {
  ...
  methods: {
    ...
    async approve() {
      ...
      var response = await this.$axios.post(config.url.transfer.boardApproval, {
      ...
      if (this.errors.length == 0) {
        ...
        this.transfer.boardApproval = true;
      }
    },
  },
};
